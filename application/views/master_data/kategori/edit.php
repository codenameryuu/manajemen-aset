            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form method="POST" action="<?php echo site_url('master-data/kategori/update'); ?>" onsubmit="return validate()" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="rounded" id="divKode">
                                    <input type="text" class="form-control" name="kode" id="kode" value="<?php echo $kategori['kode'] ?>" onkeyup="cekKode()" placeholder="Masukan Kode Kategori" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="rounded" id="divNama">
                                    <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $kategori['nama'] ?>" onkeyup="cekNama()" placeholder="Masukan Nama Kategori" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="umurEkonomis" id="umurEkonomis" value="<?php echo $kategori['umur_ekonomis'] ?>" onkeypress="return /[0-9]/i.test(event.key)" placeholder="Masukan Umur Ekonomis" autocomplete="off">
                            </div>
