            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form method="POST" action="<?php echo site_url('master-data/akun/store'); ?>" onsubmit="return validate()" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="rounded" id="divKode">
                                    <input type="text" class="form-control" name="kode" id="kode" onkeyup="cekKode()" placeholder="Masukan Kode Akun" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="rounded" id="divNama">
                                    <input type="text" class="form-control" name="nama" id="nama" onkeyup="cekNama()" placeholder="Masukan Nama Akun" autocomplete="off">
                                </div>
